...
var trafficAnimator = {
    ...
    getNetworkTrafficCanvas : function() {
        ...
        if ( this.trafficCanvas == undefined) {
            ...
            this.trafficCanvas.style.width = frame.style.clientwidth;
            this.trafficCanvas.style.height = frame.style.clientheight;
...
//              var t = edgeTraffic.edge.body.view.translation;
            ...
            this.trafficCanvasCtx.beginPath();
                ...
                this.trafficCanvasCtx.fillStyle = edgeTraffic.colorr;
